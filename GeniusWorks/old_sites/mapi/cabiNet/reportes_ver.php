  ...
  <tr>
    <td><form id="form1" name="form1" method="post" action="">
      ...
      <table width="400" border="0" align="center" cellpadding="0" cellspacing="0">
        ...
        <tr class="controles">
          <td align="right" valign="middle"><p class="controles"><img src="../imagenes/folder_full.png" alt="" width="24" height="24" /></p></td>
          <td width="200" align="right" valign="middle"><a href='reportes_resumen.php?nombre_completo=<? echo $nombre_completo;?>&amp;nivel=<? echo $nivel; ?>&amp;grupo=<? echo $grupo; ?>&amp;id_alumno=<? echo $id_alumno; ?>' class="controles">Volver al resumen de reportes</a></td>
        </tr>
      </table>
<br />
<?php
...
?>
      ...
      <table width="500" border="0" align="center" cellpadding="0" cellspacing="0">
        <tr>
          <td height="30" align="right" class="titulos_tablas">Acciones sobre este reporte: <input name="cambiar" type="button" value="  Cambiar  " class="botones" onclick="javascript:habilitar();" />  |   <input name="borrar" type="button" value="  Borrar  " class="botones" onclick="this.form.action='borrar_reporte.php'; if (confirm('¿Está seguro de borrar este reporte? Esta acción no se puede deshacer.')) { this.form.submit(); }" /></td>          
        </tr>
        <tr>
          <td height="30" align="left" class="titulos_tablas2">Área:</td>
        </tr>
        <tr class="textos">
          <td height="30" align="left" class="reportes" align="center"><input name="area" id="area" disabled="true" size="60" value="<?php echo utf8_encode($area); ?>"></td>
        </tr>
        <tr>
          <td height="30" align="left" class="titulos_tablas2">Reporte:</td>
        </tr>
        <tr class="textos">
          <td height="30" align="left" class="reportes"><textarea name="reporte" id="reporte" disabled="true" cols="80" rows="20"><?php echo utf8_encode($reporte); ?></textarea></td>
        </tr>
        <tr>
      ...
      <table width="500" border="0" align="center" cellpadding="0" cellspacing="0">
        ...
        <tr>
          ...
          <td align="right" valign="middle"><label>
            <input name="guardar" type="button" disabled="true" onclick="this.disabled=true; this.value='Guardando los cambios...'; this.form.action='actualizar_reporte.php'; this.form.submit()" class="botones" id="guardar" value="Guardar cambios al reporte" />
          </label></td>
          </tr>
          <tr height="200"></tr>
      </table>
