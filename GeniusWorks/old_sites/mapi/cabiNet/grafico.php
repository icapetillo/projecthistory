...
<center>    <table width="400" border="0" cellspacing="0" cellpadding="0">
	...
	if (($param==8) || ($param==9)) {
	$datos= mysql_query("SELECT num_cuant, subseccion, puntos, porcentaje FROM semp_cuantificaciones WHERE idalumno=$id_alumno AND num_cuant=1 AND idparametro=$param LIMIT 2", $link) or die(mysql_error());
	...
	$datos2= mysql_query("SELECT num_cuant, subseccion, puntos, porcentaje FROM semp_cuantificaciones WHERE idalumno=$id_alumno AND num_cuant=2 AND idparametro=$param LIMIT 2", $link) or die(mysql_error());
	...
	$datos= mysql_query("SELECT num_cuant, subseccion, puntos, porcentaje FROM semp_cuantificaciones WHERE idalumno=$id_alumno AND num_cuant=1 AND idparametro=$param", $link) or die(mysql_error());
	...
	$datos2= mysql_query("SELECT num_cuant, subseccion, puntos, porcentaje FROM semp_cuantificaciones WHERE idalumno=$id_alumno AND num_cuant=2 AND idparametro=$param", $link) or die(mysql_error());
