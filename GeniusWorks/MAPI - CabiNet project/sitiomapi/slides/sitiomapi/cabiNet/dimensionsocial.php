    ...
    <td><form id="form1" name="form1" method="post" action="guardar_eval_dim_social.php">
      ...
      <table width="400" border="0" align="center" cellpadding="0" cellspacing="0">
        ...
        <tr>
          ...
          <td align="left" valign="middle" class="controles"><a href="tabla_dimensionsocial.php?nombre_completo=<? echo utf8_encode($nombre_completo);?>&nivel=<? echo $nivel; ?>&grupo=<? echo $grupo; ?>&id_alumno=<? echo $id_alumno; ?>" class="controles">Revisar evaluaciones cargadas</a></td>
        </tr>
      </table>
      <br />
