    ...
    <td><form id="form1" name="form1" method="post" action="tabla_parametros.php">
      ...
      <table width="400" border="0" align="center" cellpadding="0" cellspacing="0">
        <tr>
          ...
          <td align="left" valign="middle"><a href="menu_expediente.php?nombre_completo=<? echo $nombre_completo;?>&nivel=<? echo $nivel; ?>&grupo=<? echo $grupo; ?>&id_alumno=<? echo $id_alumno; ?>"><span class="controles">Volver a la portada del expediente</span></a></td>
        </tr>
      </table>
