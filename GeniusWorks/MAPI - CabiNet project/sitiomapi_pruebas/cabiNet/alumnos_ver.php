  ...
  <tr>
	...
	<tr>
	  ...
	  <td>&nbsp;</td>
        ...
        <tr>
          <td align="right" class="controles">Matrícula:</td>
          <td>&nbsp;</td>
          <td><span class="controles">
            <input name="matricula" type="text" id="matricula" size="30" value="<? echo utf8_encode($fila['matricula']); ?>" />
          </span></td>
        </tr>
        <tr>
          <td align="right" class="controles">Password:</td>
          <td>&nbsp;</td>
          <td><span class="controles">
            <input name="pass" type="text" id="pass" size="30" value="<? echo utf8_encode($fila['pass']); ?>" />
          </span></td>
        </tr>
	<tr>
          <td width="250">&nbsp;</td>
