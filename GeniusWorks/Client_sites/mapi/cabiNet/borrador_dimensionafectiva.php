...
$sql = "SELECT * FROM semp_borradores_dim_afectiva WHERE idalumno=$id_alumno AND mes=$mes AND ano=$ano ORDER BY id_parametro ASC";
...
?>
	...
	?>        
	  ...
	  <input name="button" type="button" onclick="if (confirm('¿Seguro que desea eliminar este borrador? Esta acción NO se puede deshacer.')){ this.form.action='borrar_borrador_dim_afectiva.php'; this.disabled=true; this.value='Eliminando...'; this.form.submit()}" class="botones" id="button" value="Eliminar este borrador" />
