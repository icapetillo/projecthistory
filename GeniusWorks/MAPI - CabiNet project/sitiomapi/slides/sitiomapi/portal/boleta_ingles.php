...
<table width="750" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
    <td align="center" bgcolor="#FFFFFF"><form id="form1" name="form1" method="post" action="boleta.php"><table width="600" border="0" cellspacing="0" cellpadding="0">
      ...
      <tr>
        <td colspan="3" align="center" bgcolor="#FFFFFF" class="titulo_boleta">Tabla de avance individual (ingl&eacute;s)</td>
        </tr>
      <tr>
      ...
      <table width="700" border="0" cellspacing="0" cellpadding="0">
        <tr class="titulos_tablas">
          ...
          <td width="50" align="center" valign="middle">Part.</td>
          <td width="50" align="center" valign="middle">Exp. Oral</td>
          <td width="50" align="center" valign="middle">Exp. Escrita</td>
          <td width="50" align="center" valign="middle">Comp. Lectura</td>
          <td width="50" align="center" valign="middle"><p>Comp. Aud.</p></td>
          <td width="50" align="center" valign="middle">Cond.</td>
          <td width="50" align="center" valign="middle">Ex. Oral</td>
          <td width="50" align="center" valign="middle">Ex. Escrito</td>
          <td width="50" height="30" align="center" valign="middle" bgcolor="#0033CC">CALIF</td>
        </tr>
        <? 
  ...
  <tr>
    ...
    <td><table width="350" border="0" cellpadding="0" cellspacing="0" class="borde_boleta">
      ...
      <tr>
        ...
        <td height="30" bgcolor="#FFFFFF" class="datos_boleta">Expresi&oacute;n Oral</td>
      </tr>
      <tr>
        <td height="30" class="titulos_tablas">Exp. Escrita</td>
        <td height="30" bgcolor="#FFFFFF" class="datos_boleta">Expresi&oacute;n Escrita</td>
      </tr>
      <tr>
        <td height="30" class="titulos_tablas">Comp. Lectora</td>
        <td height="30" bgcolor="#FFFFFF" class="datos_boleta">Comprensi&oacute;n Lectora</td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td height="30" bgcolor="#FFFFFF" class="datos_boleta">Examen Escrito</td>
      </tr>
      <tr>
        <td height="30" class="titulos_tablas">CALIF</td>
        <td height="30" bgcolor="#FFFFFF" class="datos_boleta">Calificaci&oacute;n final</td>
      </tr>
    </table></td>
    <td>&nbsp;</td>
  </tr>
