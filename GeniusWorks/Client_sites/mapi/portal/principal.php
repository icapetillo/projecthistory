...
<table class="tablas" width="750" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
...
<label>
  <input type="submit" name="button3" id="button3" value="Consultar calificaciones" />
            ...
            <td align="center" valign="middle"><form id="form2" name="form2" method="post" action="listadetareas_ingles.php">
<input name="grado" type="hidden" value="<? echo $grado ?>" />
<input name="nombre" type="hidden" value="<? echo $nombre ?>" />
              <input name="matricula" type="hidden" value="<? echo $matricula ?>" />
Grupo: <select name="grupo" id="grupo">
	<option>PRIMERO VERDE</option>
	<option>PRIMERO AZUL</option>
...
<label>
  <input type="submit" name="button2" id="button2" value="Consultar tareas de ingl&eacute;s" />
</label>
            </form></td>
          </tr>
        </table></td>
