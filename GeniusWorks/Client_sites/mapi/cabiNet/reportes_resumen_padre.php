...
<br />
      <table width="600" border="0" align="center" cellpadding="0" cellspacing="0">
       ...
       while($fila = mysql_fetch_array($datos)) {
       	...
       	echo "<td width='90' align='center'><a href='reportes_ver_padre.php?idreporte=$num_reporte&nombre_completo=$nombre_completo&nivel=$nivel&grupo=$grupo&id_alumno=$id_alumno'><img src='search.png' alt='Ver este reporte' border='0'></td>";       	
       	echo "</tr>";
       	$num_fila++;
       	} 
       ?>
