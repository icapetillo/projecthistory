...
mysql_query("INSERT INTO posts (title, thumb_img, post_img, post_content, date, time, author, status) VALUES ('$titulo', '$destino1', '$destino2', '$contenido', '$post_date','$post_time','admin','1')") or die(mysql_error());
	
echo "<script language='javascript'>"; 
echo "alert('Le message a bien été envoyé. Il est maintenant visible sur la page d´accueil du site.');";
