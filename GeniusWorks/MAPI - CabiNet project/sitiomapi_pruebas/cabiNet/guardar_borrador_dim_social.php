...
$sql = "SELECT * FROM semp_borradores_dim_social WHERE mes=$mes AND ano=$ano AND idalumno=$id_alumno";
...
//Insertar nuevos registros
	for ($k=0;$k<14;$k++){
		$j=$k+1;
		mysql_query("INSERT INTO semp_borradores_dim_social (idalumno, nivel, grupo, mes, ano, id_parametro, evaluacion) VALUES ('$id_alumno', '$nivel', '$grupo', '$mes', '$ano','$j','$evaluacion[$k]')") or die(mysql_error());
		};
	...
	//Es borrador
	echo "document.location=('borrador_dimensionsocial.php?nombre_completo=$nombre_completo&nivel=$nivel&grupo=$grupo&id_alumno=$id_alumno&mes=$mes&ano=$ano');";	
	}	
	echo "</script>";
}
else
