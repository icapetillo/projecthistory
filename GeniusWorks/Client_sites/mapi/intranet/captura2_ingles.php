        ...
        <td colspan="2"><form name="calificaciones" action="insertar_ingles.php" method="post" target="mainFrame" onsubmit="return confirmar();">
          <table width="800" border="0" align="center" cellpadding="0" cellspacing="0" class="controles">
            ...
            <tr>
              ...
              <td width="50" height="30" align="center" valign="middle">Examen</td>
              <td width="50" height="30" align="center" valign="middle">Cond.</td>
              <td width="50" align="center" valign="middle">Part.</td>
              <td width="50" align="center" valign="middle">Com. Oral</td>
              <td width="50" height="30" align="center" valign="middle">Com. Esc.</td>
              <td width="50" height="30" align="center" valign="middle">Comp. Aud.</td>
              <td width="50" height="30" align="center" valign="middle">Comp. Lect.</td>
            ...
            <tr>
			  ...
			  $datos = mysql_query('SELECT * FROM ingles WHERE grupo="'.$grupo.'"');
