...
<table width="800" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
    <td width="650" align="center"><img src="../imagenes/TopDimensionAfectiva.jpg" width="500" height="48" /></td>
  </tr>
  <tr>
...
<br />
      <table width="600" border="0" align="center" cellpadding="0" cellspacing="0">
       <tr class="titulos_tablas" height="30">
       	<td valign="middle" width="300"><a href='reportes_nuevo.php?nombre_completo=<? echo $nombre_completo;?>&amp;nivel=<? echo $nivel; ?>&amp;grupo=<? echo $grupo; ?>&amp;id_alumno=<? echo $id_alumno; ?>' class="titulos_tablas">Crear un nuevo reporte</a></td>
       	<td><a href="javascript:location.reload();" class="titulos_tablas">Actualizar</a></td>
       </tr>
       <tr></tr>
       <tr><td colspan="6"><h2>Ultimos reportes cargados para el alumno</h2></td></tr>
       <tr class="titulos_tablas">
       	<td width="100">Fecha</td><td width="200">Área</td><td width="210">Maestro</td><td width="90">Ver reporte</td>
       </tr>
       <!-- introducir código para generar la lista de reportes -->
       <?php
       include("conexion.php");
       $datos = mysql_query("Select * from semp_reportes where idalumno=$id_alumno order by ano DESC, mes DESC");
       $num_fila=0;       
       while($fila = mysql_fetch_array($datos)) {
       	...
       	echo "<td width='200' align='center'>".utf8_encode($fila['area'])."</td>";
       	echo "<td width='210' align='center'>".$fila['maestro']."</td>";
       	echo "<td width='90' align='center'><a href='reportes_ver.php?idreporte=$num_reporte&nombre_completo=$nombre_completo&nivel=$nivel&grupo=$grupo&id_alumno=$id_alumno'><img src='search.png' alt='Ver este reporte' border='0'></td>";       	
       	echo "</tr>";
       	$num_fila++;
       	} 
       ?>
