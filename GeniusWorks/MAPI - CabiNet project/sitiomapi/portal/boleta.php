...
<table width="750" border="0" align="center" cellpadding="0"
	...
	<tr>
		...
		<table width="600" border="0" cellspacing="0" cellpadding="0">
			...
			<tr>
				<td colspan="3" align="center" bgcolor="#FFFFFF"
					class="titulo_boleta">Tabla de avance individual</td>
			</tr>
			<tr>
		...
		<table width="600" border="0" cellspacing="0" cellpadding="0">
			<tr class="titulos_tablas">
				...
				<td width="50" height="30" align="center" valign="middle"
					bgcolor="#0033CC">Cond.</td>
				<td width="50" height="30" align="center" valign="middle"
					bgcolor="#0033CC">OyA</td>
				<td width="50" height="30" align="center" valign="middle"
					bgcolor="#0033CC">Asist.</td>
				<td width="50" height="30" align="center" valign="middle"
					bgcolor="#0033CC">Tar.</td>
				<td width="50" height="30" align="center" valign="middle"
					bgcolor="#0033CC">Part.</td>
				<td width="50" height="30" align="center" valign="middle"
					bgcolor="#0033CC">Exam.</td>
				<td width="50" height="30" align="center" valign="middle"
					bgcolor="#0033CC">Total</td>
			</tr>
			<?
			if ($grado<4){
	...
	<tr>
		...
		<table width="350" border="0" cellpadding="0" cellspacing="0"
			...
			<tr>
				...
				<td width="300" bgcolor="#FFFFFF" class="datos_boleta">Conducta en
				el aula</td>
			</tr>
			<tr>
