    ...
    <td>
      <table width="400" border="0" align="center" cellpadding="0" cellspacing="0">
        ...
        <tr>
		  ...
		  ?>
            <input type="hidden" name="idparametro" id="idparametro" value="<? echo $param; ?>" /></td>
        </tr>
        <tr>
...
<center>    <table width="400" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td colspan="3" class="titulos_tablas2">Datos de la cuantificación</td>
        </tr>
      <tr>
	...
	if (($param==8) || ($param==9)) {
	$datos= mysql_query("SELECT num_cuant, subseccion, puntos, porcentaje FROM semp_cuantificaciones WHERE idalumno=$id_alumno AND idparametro=$param AND num_cuant=1 LIMIT 2", $link) or die(mysql_error());
	...
	$datos2= mysql_query("SELECT num_cuant, subseccion, puntos, porcentaje FROM semp_cuantificaciones WHERE idalumno=$id_alumno AND idparametro=$param AND num_cuant=2 LIMIT 2", $link) or die(mysql_error());
	...
	$datos= mysql_query("SELECT num_cuant, subseccion, puntos, porcentaje FROM semp_cuantificaciones WHERE idalumno=$id_alumno AND idparametro=$param AND num_cuant=1", $link) or die(mysql_error());
	...
	$datos2= mysql_query("SELECT num_cuant, subseccion, puntos, porcentaje FROM semp_cuantificaciones WHERE idalumno=$id_alumno AND idparametro=$param AND num_cuant=2", $link) or die(mysql_error());
