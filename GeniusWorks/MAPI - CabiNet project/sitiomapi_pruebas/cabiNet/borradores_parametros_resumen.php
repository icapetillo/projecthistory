...
<br />
      <table width="600" border="0" align="center" cellpadding="0" cellspacing="0">
       ...
       $datos = mysql_query("Select Distinct mes, ano, idpar from semp_borradores_parametros where idalumno=$id_alumno order by ano DESC, mes DESC");
       $num_fila=0;       
	...
	$ano1=$fila['ano'];
       	...
       	echo "<td width='90' align='center'><a href='borrador_parametro_7meses.php?param=$param&nombre_completo=$nombre_completo&nivel=$nivel&grupo=$grupo&id_alumno=$id_alumno&mes=$mes1&ano=$ano1'><img src='search.png' alt='Ver este borrador' border='0'></td>";      	
       	echo "</tr>";
       	$num_fila++;
       	} 
       ?>
