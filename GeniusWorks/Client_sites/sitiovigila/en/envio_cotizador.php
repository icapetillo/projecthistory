...
$sujeto = "Solicitud de cotización desde SeguridadVigila.com";

/* aquí se construye el encabezado del correo (puedes dejarlo sin modificar)*/ 
$encabezado = "From: $contacto <$email>";
$encabezado .= "\nReply-To: $email";
...
$mensaje .= "NUM. DE GUARDIAS = $guardias\n";
$mensaje .= "HORARIOS QUE MANEJA = $turnos\n";
$mensaje .= "TIPO DE EMPRESA = $tipoEmpresa\n";
$mensaje .= "TIPO DE UNIFORME = $uniforme\n";
$mensaje .= "REQUIERE PISTOLAS = $pistolas\n";
$mensaje .= "CUANTAS PISTOLAS = $num_pistolas\n";
$mensaje .= "PUESTOS A CUBRIR = $puestos\n";
