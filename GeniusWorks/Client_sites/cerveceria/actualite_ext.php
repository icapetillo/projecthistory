...
$datos = mysql_query("SELECT * FROM posts WHERE status=1 ORDER BY post_id DESC");
...
<div>
  ...
  <tr>
    <td height="100" valign="top" class="message">'.$preview.'<br /><div id="footnote" class="footnote" >'.$fila['date'].'</td>
  </tr>
  <tr>
...
<p align="center"><a href="javascript:history.back();" class="lirelasuite"> Retour </a></p>
</body>
</html>