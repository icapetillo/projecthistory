...
<br />
      <table width="500" border="0" align="center" cellpadding="0" cellspacing="0">
        <tr class="textos">
          <td height="30" align="left">Área:</td>
          </tr>
        <tr class="textos">
          <td height="30" align="left"><input name="txarea" type="text" id="txarea" size="40" /></td>
          </tr>
        <tr class="textos">
          <td height="30" align="left">Reporte:</td>
          </tr>
        <tr class="textos">
          <td height="30" align="left"><textarea name="reporte" id="reporte" cols="75" rows="15"></textarea></td>
          </tr>
        <tr class="textos">
      ...
      <table width="500" border="0" align="center" cellpadding="0" cellspacing="0">
        ...
        <tr>
          <td align="right" valign="middle"><label>
            <input name="button" type="button" onclick="this.disabled=true; this.value='Guardando...'; this.form.submit()" class="botones" id="button" value="Guardar reporte" />
          </label></td>
          </tr>
      </table>
    </form></td>
