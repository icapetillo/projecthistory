...
<table width="450" border="1" align="center" cellpadding="0" cellspacing="0">
  <tr>
    <td><table width="400" border="0" align="center" cellpadding="0" cellspacing="0">
      ...
      <tr>
        <td colspan="2" bgcolor="#FF6600" class="titulos"><center>
          Consulta de tareas encargadas
        </center></td>
      </tr>
      <tr>
        <td colspan="2">&nbsp;</td>
      ...
      <tr>
        <td colspan="2"><form name="calificaciones" action="consulta_tareas_ingles.php" method="post">
          <table width="100%" border="0" cellspacing="0" cellpadding="0">
            ...
            <tr>
              <td>&nbsp;</td>
              <td>
                <input name="button" type="submit" class="botones" id="button" value="Consultar tareas cargadas" /></td>
            </tr>
          </table>
        </form></td>
      </tr>
