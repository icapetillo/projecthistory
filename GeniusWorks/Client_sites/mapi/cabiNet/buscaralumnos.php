...
<tr valign="top">
	...
	<table width="130" border="0" align="center" cellpadding="0" cellspacing="0">
	      ...
	      <tr>
	        <td height="30" valign="middle" bgcolor="#FFFFFF"><span class="controles"><img src="../imagenes/add.png" alt="" width="16" height="16" /><a href="registralumnos.php" class="controles">Agregar...</a></span></td>
	      </tr>
...
<!-- Resultados de la busqueda -->
	<table width="650" border="0" align="center" cellpadding="0" cellspacing="0">
        ...
        <tr>
          <td width="200" align="center" class="titulos_tablas">Matrícula</td>
	...
	if (isset($parametro))
	{
		if ($tipo==1) {$param='matricula';}
		if ($tipo==2) {$param='appaterno'; }
		if ($tipo==3) {$param='nombres';}
		include('conexion.php');
		$datos=mysql_query("select * from semp_alumnos where $param like '%$parametro%' order by matricula asc");
		$i=0;
		while ($fila=mysql_fetch_array($datos))
		{
			...
			echo "<td width='200' align='center'>".$fila['matricula']."</td>";
			echo "<td width='400'>".utf8_encode($fila['appaterno'])." ".utf8_encode($fila['apmaterno'])." ".utf8_encode($fila['nombres'])."</td>";
			echo "<td align='center'><a href='alumnos_ver.php?id_alumno=$id_alumno'><img src='../imagenes/edit.png' width='16' height='16' border='0' alt='Borrar usuario' /></a></td>";
			echo "<tr>";
			$i++;
		}
	}
