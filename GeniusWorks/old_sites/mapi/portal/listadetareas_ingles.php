...
<table class="tablas" align="center" border="0" cellpadding="0"
	...
	<tr>
		...
		<table border="0" cellpadding="0" cellspacing="0" width="600">
			<tbody>
				...
				<tr class="datos_alumno">
					<td width="150" height="30" align="center" bgcolor="#FFFFFF"><? echo $matricula; ?></td>
					<td width="300" height="30" align="center" bgcolor="#FFFFFF"><? echo $nombre; ?></td>
					<td width="150" height="30" align="center" bgcolor="#FFFFFF"><? echo $mes ?> , <? echo $ano ?></td>
				</tr>
				<tr class="datos_alumno">
					<td height="30" colspan="3" align="center" bgcolor="#FFFFFF">A
					continuaci&oacute;n se describe la lista de tareas encargadas para
					el periodo seleccionado en la materia de inglés. Las tareas m&aacute;s recientes se listan en primer orden.</td>
				</tr>
				<tr class="datos_alumno">
		...
		<table width="600" border="1" cellspacing="0" cellpadding="0">
			...
			$datos = mysql_query("SELECT * FROM tareas WHERE mes='".$mes."' and ano='".$ano."' and (grado='".$grado."' or grado=7) and (grupo='".$grupo."' or materia='Ingles') ORDER BY idtarea DESC");
