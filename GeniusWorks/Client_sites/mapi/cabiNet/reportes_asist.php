      ...
      <table width="500" border="0" align="center" cellpadding="0" cellspacing="0">
        ...
        <tr>
          <td align="right" valign="middle"><label>
            <input name="button" type="button" onclick="if (confirm('¿Seguro que desea guardar? Esta acción no se puede deshacer.')){ this.disabled=true; this.value='Guardando...'; this.form.submit()}" class="botones" id="button" value="Guardar reporte de asistencias" />
          </label></td>
          </tr>
      </table>
    </form></td>
