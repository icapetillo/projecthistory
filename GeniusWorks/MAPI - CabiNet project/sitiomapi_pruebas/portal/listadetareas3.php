...
<table width="750" border="0" align="center" cellpadding="0"
	cellspacing="0">
	<tr>
		<td width="18" rowspan="3" align="center" bgcolor="#FFFFFF"
			background="../imagenes/background-izq.gif">&nbsp;</td>
		<td height="30" align="left"
			background="../imagenes/fondoTablaNavega.png" bgcolor="#FFFFFF"><span
		...
		<td width="18" rowspan="3" align="center"
			background="../imagenes/background-der.gif" bgcolor="#FFFFFF">&nbsp;</td>
	</tr>
	<tr>
		...
		<table width="600" border="0" cellspacing="0" cellpadding="0">
			...
			<tr>
				<td colspan="3" align="center" bgcolor="#FFFFFF"
					class="titulo_boleta">Lista de tareas encargadas en el periodo</td>
			</tr>
			<tr>
	...
	<tr>
		<td width="18" height="14" background="../imagenes/esq-izq-inf.gif"
			bgcolor="#FFFFFF">&nbsp;</td>
		<td height="14" bgcolor="#FFFFFF"
			background="../imagenes/background-inf.gif">&nbsp;</td>
		<td height="14" bgcolor="#FFFFFF"
			background="../imagenes/esq-der-inf.gif">&nbsp;</td>
	</tr>
</table>
<p>&nbsp;</p>
<p>&nbsp;</p>
