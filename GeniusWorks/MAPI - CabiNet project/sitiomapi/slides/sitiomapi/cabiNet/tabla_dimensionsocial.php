...
<table width="800" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
    <td><form id="form1" name="form1" method="post" action="tabla_dimensionsocial.php">
      ...
      <table width="400" border="0" align="center" cellpadding="0" cellspacing="0">
        <tr>
          ...
          <td width="200" align="left" valign="middle"><a href="dimensionsocial.php?nombre_completo=<? echo utf8_encode($nombre_completo);?>&nivel=<? echo $nivel; ?>&grupo=<? echo $grupo; ?>&id_alumno=<? echo $id_alumno; ?>"><span class="controles">Volver a la captura de evaluaciones</span></a></td>
        </tr>
      </table>
