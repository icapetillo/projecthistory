...
<table width="800" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
    <td><form id="form1" name="form1" method="post" action="tabla_parametros.php">
      ...
      <table width="400" border="0" align="center" cellpadding="0" cellspacing="0">
        <tr>
          ...
          <td width="200" align="left" valign="middle"><a href="parametro_7meses.php?nombre_completo=<? echo utf8_encode($nombre_completo);?>&nivel=<? echo $nivel; ?>&grupo=<? echo $grupo; ?>&id_alumno=<? echo $id_alumno; ?>"><span class="controles">Volver a la portada del expediente</span></a></td>
        </tr>
      </table>
      ...
      <table width="750" border="0" align="center" cellpadding="0" cellspacing="0">
        <tr>
          <td width="450" rowspan="2" valign="top"><table width="450" border="1" align="center" cellpadding="0" cellspacing="0">
			...
			$datos=mysql_query("SELECT id_par, descripcion FROM semp_parametros_desarrollo WHERE idparametro=$idparametro",$link) or die(mysql_error());
			$num_aspectos=mysql_num_rows($datos);
			while($fila=mysql_fetch_array($datos)){
				echo "<tr class='textos'>";
				echo "<td width='30' height='30'>".$fila['id_par']."</td>";
				echo "<td width='420' height='30'>".utf8_encode($fila['descripcion'])."</td>";
				}
			?>
        ...
        <tr>
          <td width="95" valign="top"><table border="1" cellpadding="0" cellspacing="0">
            <?php
		  include("conexion.php");
		  $datos1 = mysql_query("SELECT * FROM semp_eval_parametros WHERE idalumno=".$id_alumno." and ano=".$ano." AND idpar=$idparametro ORDER BY idparametro ASC",$link);
		...
		for ($k=1; $k<=$num_aspectos; $k++)
		{
          ...
          <td width="205" valign="top">
            <table border="1" cellpadding="0" cellspacing="0">
               <?php
		  include("conexion.php");
		  $datos2 = mysql_query("SELECT * FROM semp_eval_parametros WHERE idalumno=".$id_alumno." and ano=".$ano2." AND idpar=$idparametro ORDER BY idparametro ASC",$link);
