...
?>		<input type="hidden" name="cuant" id="cuant" value="<? echo $cuant; ?>" /></td>
      ...
      <table width="400" border="0" align="center" cellpadding="0" cellspacing="0">
        <tr>
          ...
          <td width="200" align="left" valign="middle"><a href='menu_expediente_padre.php?nombre_completo=<? echo utf8_encode($nombre_completo);?>&nivel=<? echo $nivel; ?>&grupo=<? echo $grupo; ?>&id_alumno=<? echo $id_alumno; ?>'><span class="controles">Volver a la portada del expediente</span></a></td>
        </tr>
      </table>
</td>
  </tr>
...
//			  }
			  ...
			  $aspectos=mysql_query("SELECT * FROM semp_eval_parametros WHERE mes=$mes_cuant AND idpar=$idparametro AND subseccion=1 AND idalumno=$id_alumno",$link) or die(mysql_error());
			  
			  $num=mysql_num_rows($aspectos);
			  
			  $datos=mysql_query("SELECT SUM(eval) AS puntos FROM semp_eval_parametros WHERE mes=$mes_cuant AND idpar=$idparametro AND subseccion=1 AND idalumno=$id_alumno",$link) or die(mysql_error());
			  ...
			  echo "<td><input type='hidden' name='subseccion' id='subseccion' value='$subseccion' />Cognitivos</td>";
			  ...
			  echo "<td align='center'><input type='hidden' name='porc' id='porc' value='".number_format($porc,2)."' />".number_format($porc,2)."/25</td>";	
			   ...
			   $aspectos=mysql_query("SELECT * FROM semp_eval_parametros WHERE mes=$mes_cuant AND idpar=$idparametro AND subseccion=2 AND idalumno=$id_alumno",$link) or die(mysql_error());
			  
			  $num=mysql_num_rows($aspectos);
			  
			  $datos=mysql_query("SELECT SUM(eval) AS puntos FROM semp_eval_parametros WHERE mes=$mes_cuant AND idpar=$idparametro AND subseccion=2 AND idalumno=$id_alumno",$link) or die(mysql_error());
			  ...
			  echo "<tr height='30' class='textos'>";
			  echo "<td><input type='hidden' name='subseccion' id='subseccion' value='$subseccion' />Sociales</td>";
			  echo "<td align='center'><input type='hidden' name='pts' id='pts' value='".$pts."' />".$pts."/".$num."</td>";
			  echo "<td align='center'><input type='hidden' name='porc' id='porc' value='".number_format($porc,2)."' />".number_format($porc,2)."/25</td>";	
			  
			   $aspectos=mysql_query("SELECT * FROM semp_eval_parametros WHERE mes=$mes_cuant AND idpar=$idparametro AND subseccion=3 AND idalumno=$id_alumno",$link) or die(mysql_error());
			  
			  $num=mysql_num_rows($aspectos);
			  
			  $datos=mysql_query("SELECT SUM(eval) AS puntos FROM semp_eval_parametros WHERE mes=$mes_cuant AND idpar=$idparametro AND subseccion=3 AND idalumno=$id_alumno",$link) or die(mysql_error());
			  ...
			  echo "<tr height='30' class='textos'>";
			  echo "<td><input type='hidden' name='subseccion' id='subseccion' value='$subseccion' />Vida Independiente</td>";
			  echo "<td align='center'><input type='hidden' name='pts' id='pts' value='".$pts."' />".$pts."/".$num."</td>";
			  echo "<td align='center'><input type='hidden' name='porc' id='porc' value='".number_format($porc,2)."' />".number_format($porc,2)."/25</td>";	
			  
			  
			   $aspectos=mysql_query("SELECT * FROM semp_eval_parametros WHERE mes=$mes_cuant AND idpar=$idparametro AND subseccion=4 AND idalumno=$id_alumno",$link) or die(mysql_error());
			  
			  $num=mysql_num_rows($aspectos);
			  
			  $datos=mysql_query("SELECT SUM(eval) AS puntos FROM semp_eval_parametros WHERE mes=$mes_cuant AND idpar=$idparametro AND subseccion=4 AND idalumno=$id_alumno",$link) or die(mysql_error());
			  ...
			  echo "<tr height='30' class='textos'>";
			  echo "<td><input type='hidden' name='subseccion' id='subseccion' value='$subseccion' />Motricidad</td>";
			  echo "<td align='center'><input type='hidden' name='pts' id='pts' value='".$pts."' />".$pts."/".$num."</td>";
			  echo "<td align='center'><input type='hidden' name='porc' id='porc' value='".number_format($porc,2)."' />".number_format($porc,2)."/25</td>";	
