      ...
      <tr>
        <td colspan="2"><table width="800" border="0" align="center" cellpadding="0" cellspacing="0">
          <tr>
            ...
            <td width="50" height="30" align="center" valign="middle" class="titulos_tablas">Comp, Lect.</td>
            <td width="50" height="30" align="center" valign="middle" class="titulos_tablas">Comp. Audit.</td>
            <td width="50" height="30" align="center" valign="middle" class="titulos_tablas">Cond.</td>
            <td width="50" height="30" align="center" valign="middle" class="titulos_tablas">Ex. Oral</td>
            <td width="50" align="center" valign="middle" class="titulos_tablas">Ex. Escrito</td>
		...
		if ($cant>0)
		{
			...
			echo "<td height='30' align='center' valign='middle'>".$fila['ex_esc']."</td>";
