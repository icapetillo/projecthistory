      ...
      <table width="600" border="0" align="center" cellpadding="0" cellspacing="0">
        <tr>
          ...
          <?
			...
			$datos = mysql_query("SELECT * FROM semp_asistencias WHERE idalumno=$id_alumno ORDER BY ano DESC, mes DESC",$link);
	       ...
	       echo "<tr><td width='200' class='textos' height='40'><div align='center'>".$mes_nombre."/".$fila['ano']."</div></td>";
               ...
               echo "<td width='100' class='textos' height='40' align='center'><div align='center'>".$fila['faltas']."</div></td></tr>";
		   }	   
		?>
