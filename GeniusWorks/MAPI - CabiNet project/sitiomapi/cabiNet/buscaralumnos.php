  ...
  <tr>
    <td><form id="form1" name="form1" method="post" action="">
      <table width="650" border="0" align="center" cellpadding="0" cellspacing="0">
        <tr>
          <td colspan="3" align="right"><img src="../imagenes/topBuscarAlumno.jpg" width="400" height="54" /></td>
        </tr>
        <tr>
          <td align="right">&nbsp;</td>
          <td>&nbsp;</td>
        ...
        <tr>
          <td colspan="3" align="left" class="textos">Escriba el nombre del alumno que desea buscar para encontrar sus datos..</td>
        </tr>
        <tr>
          <td align="right">&nbsp;</td>
          <td>&nbsp;</td>
        ...
        <tr>
          <td width="250" align="right"><span class="controles">Nombre del alumno:</span></td>
          <td width="20">&nbsp;</td>
          <td width="380"><span class="controles"><input name="txApPat4" type="text" id="txApPat4" size="30" />
            <input name="btGrabar" type="submit" class="botones" id="btGrabar" value="Buscar alumno" />
            </span></td>
        </tr>
        <tr>
          <td width="250">&nbsp;</td>
