...
<body>
<div align="center">
  <table width="634" height="446" align="center">
    <tr>
      <td width="511" height="440" class="Borde_celda"><form id="form1" name="form1" method="POST" action="<?php echo $loginFormAction; ?>">
        ...
        <div class="Logo1"><span class="Fuente2">
          <input name="button" type="submit" class="Boton1" id="button" value="Ingresar" />
        </span></div>
        <p>&nbsp;</p>
        <div class="Logo1"><span class="Fuente2">
        <input name="button2" type="button" class="Boton1" id="button2" value="Cancelar" />
        </span></div>
        <p>&nbsp;</p>
      </form></td>
    </tr>
